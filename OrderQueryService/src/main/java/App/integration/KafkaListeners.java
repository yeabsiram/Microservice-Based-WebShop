...
public class KafkaListeners {
    ...
    public void productChangeListener(@Payload String productChangeDTOString)
    {
        ...
        try{
            ...
            System.out.println(productChangeDTO);
...
//        orderService.handle(paymentChangeDTO);
    ...
    @KafkaListener(topics = {"orderChangedTopic"})
    public void orderChangeListener(@Payload String orderChangeDTO)
    {

        ObjectMapper objectMapper = new ObjectMapper();
        try{
            OrderChangeDTO orderChangeDTO1 = objectMapper.readValue(orderChangeDTO, OrderChangeDTO.class);
            orderService.handle(orderChangeDTO1);
